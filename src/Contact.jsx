...
const Contact = () => {
  ...
  return (
    <div className='h-screen flex flex-col justify-center items-center bg-black text-green-400 px-6 relative'>
        ...
        className='absolute w-96 h-96 bg-green-500 opacity-20 rounded-full blur-3xl'>
        ...
        <div className='mt-12 bg-gray-900 p-6 rounded-lg border border-green-500 w-fulll
         max-w-lg text-lg font-mono relative z-10'>
            <p>user@portfolio: ~$</p>
            <p>{text}</p>
        </div>
